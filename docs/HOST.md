...
| 7 | peek select | `uo_out` mux |

Peek select: 0 PC0, 1 X0, 2 Y0, 3 ISR0, 4 OSR0, 5 FIFO flags, 6 capture wptr, 7 pins, 8 PC1, 9 X1, 10 RX0, 11 RX1.
